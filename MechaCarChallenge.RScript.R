...
?t.test()
t.test(subset(coils, Manufacturing_Lot == "Lot1", select = PSI), mu = 1500)
t.test(subset(coils, Manufacturing_Lot == "Lot2", select = PSI), mu = 1500)
t.test(subset(coils, Manufacturing_Lot == "Lot3", select = PSI), mu = 1500)
